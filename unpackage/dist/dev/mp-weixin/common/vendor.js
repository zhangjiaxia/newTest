...
/***/ 134:
/*!*********************************************************************************************************!*\
  !*** D:/Personal/Documents/HBuilderProjects/uniCoach/components/mpvue-citypicker/city-data/province.js ***!
  \*********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 135:
/*!*****************************************************************************************************!*\
  !*** D:/Personal/Documents/HBuilderProjects/uniCoach/components/mpvue-citypicker/city-data/city.js ***!
  \*****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 136:
/*!*****************************************************************************************************!*\
  !*** D:/Personal/Documents/HBuilderProjects/uniCoach/components/mpvue-citypicker/city-data/area.js ***!
  \*****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 15:
/*!**********************************************************************!*\
  !*** D:/Personal/Documents/HBuilderProjects/uniCoach/store/index.js ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
new _vuex.default.Store({
  ...
  mutations: {
    ...
    setUserInfos: function setUserInfos(state, newValue) {
      state.userInfos = newValue;
    },
    setChooseCourse: function setChooseCourse(state, newValue) {
      state.chooseCourse = newValue;
    },
    setChooseGoods: function setChooseGoods(state, newValue) {
      state.chooseGoods = newValue;
    },
    setCoachBook: function setCoachBook(state, newValue) {
      state.coachBook = newValue;
    },
    setDynamicDesc: function setDynamicDesc(state, newValue) {
...
/***/ 23:
/*!**************************************************************************!*\
  !*** D:/Personal/Documents/HBuilderProjects/uniCoach/utils/interface.js ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _store = _interopRequireDefault(__webpack_require__(/*! @/store */ 15));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //引入请求api
//引入全局变量的token
var isFormal = false; //是否正式,false:测试，true:正式

var baseUrlTest = "https://fitness.bidou88.cn/api"; //测试域名，平时开发用测试域名
var baseUrlFormal = ""; //正式域名，提交文件时要切换到正式域名
...
var interfaceurl = {
  ...
  showBussisnessErr: function showBussisnessErr(res) {
    ...
    if (res.code == 0) {
      ...
      if (res.code == 401) {
        _store.default.commit('updateToken', '');
    ...
    uni.login({
      success: function success(res) {
        if (res.code) {
          //这里直接用原生请求就行了
          uni.request({
            url: "".concat(baseUrl, "/v1/login/getToken"),
            data: {
              code: res.code },
            ...
            success: function success(res) {
              ...
              if (detail.userInfo) {
                ...
                then(function (res) {
                  ...
                  _store.default.commit('setUserInfos', userInfo);
  ...
  /*首页*/
  bannerList: function bannerList(data) {return _request.default.request({ url: "".concat(baseUrl, "/v1/home/bannerList"), data: data });},
  goodsList: function goodsList(data) {return _request.default.request({ url: "".concat(baseUrl, "/v2/home/goodsList"), data: data }, false);},
  classesList: function classesList(data) {return _request.default.request({ url: "".concat(baseUrl, "/v2/home/classesList"), data: data }, false);},
  ...
  /*商品*/
  goodsDetails: function goodsDetails(data) {return _request.default.request({ url: "".concat(baseUrl, "/v1/goods/details"), data: data });},
  directBuy: function directBuy(data) {return _request.default.request({ url: "".concat(baseUrl, "/v1/goods/directBuy"), data: data, method: 'POST' });},
  // /*用户*/
  ...
  reservation: function reservation(data) {return _request.default.request({ url: "".concat(baseUrl, "/v1/user/reservation"), data: data, method: 'POST' });},
  //账号123密码123123
  teacherLogin: function teacherLogin(data) {return _request.default.request({ url: "".concat(baseUrl, "/v1/login/teacherLogin"), data: data, method: 'POST' });},
  myReservation: function myReservation(data) {return _request.default.request({ url: "".concat(baseUrl, "/v1/user/myReservation"), data: data });},
  /*收货地址*/
  addressCreate: function addressCreate(data) {return _request.default.request({ url: "".concat(baseUrl, "/v1/user_address/create"), data: data, method: 'POST' });},
  addressDelete: function addressDelete(data) {return _request.default.request({ url: "".concat(baseUrl, "/v1/user_address/delete"), data: data, method: 'DELETE' });},
  addressEdit: function addressEdit(data) {return _request.default.request({ url: "".concat(baseUrl, "/v1/user_address/edit"), data: data, method: 'POST' });},
  addressList: function addressList(data) {return _request.default.request({ url: "".concat(baseUrl, "/v1/user_address/userList"), data: data });},
  /*购物订单*/
  orderList: function orderList(data) {return _request.default.request({ url: "".concat(baseUrl, "/v1/goods_order/userList"), data: data });},
  goodsPayment: function goodsPayment(data) {return _request.default.request({ url: "".concat(baseUrl, "/v2/goods_payment/payment"), data: data, method: 'POST' });},
  /*上传*/
  uploadAli: function uploadAli(data) {return _request.default.request({ url: "".concat(baseUrl, "/v1/upload/uploadAli"), data: data, method: 'POST' });} };var _default =
...
/***/ 24:
/*!************************************************************************!*\
  !*** D:/Personal/Documents/HBuilderProjects/uniCoach/utils/request.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 4:
/*!******************************************************************!*\
  !*** D:/Personal/Documents/HBuilderProjects/uniCoach/pages.json ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 63:
/*!***************************************************************************!*\
  !*** D:/Personal/Documents/HBuilderProjects/uniCoach/common/city.data.js ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 7:
/*!***********************************************************************************!*\
  !*** D:/Personal/Documents/HBuilderProjects/uniCoach/pages.json?{"type":"style"} ***!
  \***********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/dynamic/dynamic": { "navigationBarTitleText": "动态", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/index/index": { "navigationBarTitleText": "FunFunFitness", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/dynamic/desc": { "navigationBarTitleText": "动态详情", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/my/order": { "navigationBarTitleText": "订单信息", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/shop/shop-detail": { "navigationBarTitleText": "商品详情", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/my/address-add": { "navigationBarTitleText": "新建收货地址", "usingComponents": { "mpvue-picker": "/components/mpvue-picker/mpvuePicker", "mpvue-city-picker": "/components/mpvue-citypicker/mpvueCityPicker" }, "usingAutoImportComponents": {} }, "pages/shop/course-detail": { "navigationBarTitleText": "课程详情", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/shop/course-booking": { "navigationBarTitleText": "课程预约", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/shop/shop": { "navigationBarTitleText": "商城", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/my/reserve-information": { "navigationBarTitleText": "预约信息", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/index/login": { "navigationBarTitleText": "教练登录", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/my/my": { "navigationBarTitleText": "我的", "usingComponents": { "auth-page": "/components/authorization-page" }, "usingAutoImportComponents": {} }, "pages/my/reservation": { "navigationBarTitleText": "我的预约", "usingComponents": {}, "usingAutoImportComponents": {} } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "uni-app", "navigationBarBackgroundColor": "#FFFFFF", "backgroundColor": "#F8F8F8" } };exports.default = _default;

/***/ }),

/***/ 8:
/*!**********************************************************************************!*\
  !*** D:/Personal/Documents/HBuilderProjects/uniCoach/pages.json?{"type":"stat"} ***!
  \**********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__54BB780" };exports.default = _default;
